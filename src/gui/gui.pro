...
!isEmpty(VERSION_STAGE) {
	DEFINES += "VERSION_STAGE=\"\\\"$$VERSION_STAGE\\\"\""
}

!isEmpty(VERSION_REVISION) {
	DEFINES += "VERSION_REVISION=\"\\\"$$VERSION_REVISION\\\"\""
}

!isEmpty(PRODUCT_NAME) {
	DEFINES += "PRODUCT_NAME=\"\\\"$${PRODUCT_NAME}\\\"\""
}

!isEmpty(ENABLE_ACTIVATION) {
	DEFINES += "ENABLE_ACTIVATION"
}

!isEmpty(ENABLE_UPDATE_CHECK) {
